    ...
    <main className="min-h-dvh bg-background-base pb-24">
      ...
      <div className="flex flex-col gap-6 px-4 pt-20">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0">
              <p className="text-[16px] font-[600] leading-6 text-text-primary">
                {profile.displayName}
              </p>
          ...
          <p className="text-[12px] text-text-secondary">
            Pengaturan profil & upload avatar tersedia di fase berikutnya (MVP memakai data ini).
          </p>
        </section>
        ...
        <section
          ...
          className="flex flex-col gap-3 rounded-2xl border border-border-subtle bg-surface-card p-4"
        >
